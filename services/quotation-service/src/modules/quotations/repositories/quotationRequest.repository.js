  ...
  async create(data) {
    return prisma.quotationRequest.create({
      data: {
        ...
        numberOfSites:
          data.numberOfSites !== undefined ? Number(data.numberOfSites) : null,
        siteNames: data.siteNames || [],
        activeMachines:
          data.activeMachines !== undefined
            ? Number(data.activeMachines)
            : null,
